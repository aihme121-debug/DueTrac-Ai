...
import { DynamicDemoLayout, DynamicDemoData } from '../types/dynamicDemo';

// Sample layouts for the dynamic demo
const sampleLayouts: DynamicDemoLayout[] = [
  {
    id: 'dashboard-layout',
...
const sampleData: DynamicDemoData[] = [
  {
    id: 'metric-data-1',
...
export const initializeDynamicDemo = async () => {
  try {
...
if (require.main === module) {
  initializeDynamicDemo().then(success => {
